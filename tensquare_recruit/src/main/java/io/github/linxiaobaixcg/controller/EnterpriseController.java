...
import io.github.linxiaobaixcg.pojo.Enterprise;
import io.github.linxiaobaixcg.service.EnterpriseService;
...
public class EnterpriseController {
	...
	public Result hotlist(){
		return new Result(true,StatusCode.OK.getCode(),"查询成功",enterpriseService.hotlist());
	}
